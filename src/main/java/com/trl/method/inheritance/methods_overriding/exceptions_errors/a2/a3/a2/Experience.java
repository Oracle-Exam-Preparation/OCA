package com.trl.method.inheritance.methods_overriding.exceptions_errors.a2.a3.a2;
...
class Child_E extends Parent {
    public void method() throws A_RuntimeException {               // Not Compilation exception.
        System.out.println("Child_D --> method()");
    }
}

class A_RuntimeException extends RuntimeException { }